		...
		<div class="main-grid">
			...
			<div class="agile-grids">
				<form class="form-inline" action="#" method="post"> 
					...
					<button name="submit" type="submit" class="btn btn-default w3ls-button">Search</button> 
				</form>
				<?php
									      $username = null;
                                          ...
                                          if(isset($_POST["submit"])){
											$show = "SELECT * FROM users WHERE user ='$username'  ";
											$showcase = mysqli_query($connection, $show);
											$s = mysqli_fetch_assoc($showcase);
											if($s){
                                          $show1 = "SELECT * FROM $username WHERE chek = '1'";
										  $showcase1 = mysqli_query($connection, $show1);
										  $sql = mysqli_num_rows($showcase1);
										  if($sql < 1){echo"<div class=\"alert alert-danger alert-dismissable\">
											<a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>
											<strong>  This user has not done any transaction</strong>"."<br/></div>";}
				...
				<table id="table">
					...
					<?php while ($s1 = mysqli_fetch_assoc($showcase1)){?>
					

						<tr>
						<td><?php echo $s1['transaction_id'] ?></td>
						...
						<?php }
												...
												<a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>
												<strong>  This user might have been deleted or does not exist</strong>"."<br/></div>";
											} ?>
						<?php } ?>
					</tbody>
				</table>
