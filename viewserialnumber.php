			...
			<div class="agile-grids">
				<form class="form-inline" action="#" method="post"> 
					<div class="form-group"> 
						<label for="Usernamesearch">Book Title:</label> 
						<?php
										$sql = mysqli_query($connection, "SELECT * FROM justbooks");
										echo'<input type="text" name="title" list="names" class="form-control" id="Booksearch" placeholder="Enter Book Title">';
				...
				<?php
                                          ...
                                          if(isset($_POST["submit"])){
											$show = "SELECT * FROM books WHERE title ='$title'";
				...
				<table id="table">
					...
					<?php while ($s = mysqli_fetch_assoc($showcase)){?>
					

						<tr>
						<td><?php echo $s['serialnumber'] ?></td>
						...
						<?php }
												...
												<strong>  This book might have been deleted or does not exist</strong>"."<br/></div>";
                                            }
                                          ?>
						<?php } ?>
					</tbody>
