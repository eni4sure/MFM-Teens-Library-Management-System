...
<?php
	...
	$SearchQueryParameter = $_GET['Update'];
				...
				$Query="SELECT * FROM location WHERE id = '$SearchQueryParameter'";
				$ExecuteQuery=mysqli_query($connection, $Query);
				while($DataRows=mysqli_fetch_array($ExecuteQuery)){
						$locationToBeUpdated = $DataRows['locationname'];
						$sizeToBeUpdated = $DataRows['locationsize'];
						...
						if(isset($_POST['submit'])){
                            ...
                            $update5 = "UPDATE `location` SET `locationname`='$locationname', `locationsize`='$locationsize' WHERE `id`='$UpdateFromURL'";

                           

							$edit4 = mysqli_query($connection, $update5);
							 if($edit4){
      					  		$_SESSION["SuccessMessage"]="Location Updated Successfully";
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
            ...
            <div class="agile-grids">
				...
				<div class="form-body">
					<form class="form-horizontal" action="updatelocation.php?Update=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">

						<div class="form-group"> 
							<label for="Username" class="col-sm-2 control-label">Location name</label> 
							<div class="col-sm-9"> 
								<input type="text" name="locationname"   value="<?php echo $locationToBeUpdated; ?>" class="form-control" id="Username" placeholder=" New Location"> 
							</div>
						</div>

						<div class="form-group"> 
							<label for="Book Title" class="col-sm-2 control-label">Location size</label> 
							<div class="col-sm-9"> 
								<input type="text" name="locationsize"  value="<?php echo $sizeToBeUpdated; ?>" class="form-control" id="Book Title" placeholder="New Location"> 
							</div> 
						</div>
